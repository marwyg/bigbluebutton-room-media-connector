...
const onPairingPin = (newPin: string) => {
  console.log('onPairingPin', newPin);
  pin.value = newPin;
};

// Triggered when someone enters the pin in the BBB meeting
const onVerification = (newVerificationCode: string) => {
  console.log('onVerification', newVerificationCode);
...
// Triggered when someone clicks on "cancel pairing" in the BBB meeting
function onPluginDisconnected() {
  console.log('onPluginDisconnected');
...
// Triggered when the room-hub sends a join url
const onJoinUrl = (url: string, layoutIndex: number) => {
  console.log('onJoinUrl', url, layoutIndex);
  window.electronAPI.joinMeeting(url, 0);
};

const onConnectionChanged = (status: boolean) => {
  console.log('onConnectionChanged', status);
        ...
        <template v-if="connectionState != 'idle'">
          ...
          <div
            ...
            <template v-if="connectionState == 'pairing'">
              ...
              <span>Please verify the pairing code and accept the connection if they match.</span>
              <span>Verification Code: {{ verificationCode }}</span>
              <div class="simple-side-by-side" style="gap: 1rem;">
          ...
          <div v-if="showSettingsScreen" class="box">
            ...
            <div class="box-content box--no-bottom-styling">
              ...
              <div class="settings-content scrollable">
                ...
                <div class="setting-description">The BigBlueButton Appliance Application will be displayed on this
                  screen.
                </div>
                ...
                <input type="text" class="general-input" placeholder="bbb-room-media"
                  v-model="config.room.bbb_user_id" />
                ...
                <div v-for="(layout, i) in config.room.layouts" :key="i">
                  ...
                  <div v-for="(screen, j) in layout.screens" :key="j">
                    ...
                    <div class="setting-description">Select the screen you want to use. The following join parameters
                      will
            ...
            <div class="settings-footer">
              <button class="settings-button settings-button-discard" @click="discardConfigChanges()">Discard</button>
            ...
            <div v-if="config.show_pin_display" class="box">
              ...
              <div class="box-content">
                ...
                <div class="box-description">
                  Enter the code above in your BigBlueButton meeting. The devices of this room will connect to your
                  online
            ...
            <div v-if="config.show_meeting_list" class="box">
              ...
              <div class="box-content">
                ...
                <div class="right-box-description">
                  Click on 'Join'. This will start the BigBlueButton meeting. All devices will be connected
                  automatically.
                </div>
